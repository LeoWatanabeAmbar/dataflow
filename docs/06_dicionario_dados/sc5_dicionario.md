...
O campo representa o modo operacional de faturamento do pedido.

Critérios operacionais atualmente utilizados:
...
- alterações manuais no campo C5_ZZMODF2
...
possui natureza operacional e normalmente contém observações utilizadas pela área comercial/faturamento.

O preenchimento do campo poderá impactar diretamente:
- faturamento
